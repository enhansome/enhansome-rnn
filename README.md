# Awesome Recurrent Neural Networks with stars
...
We have pages for other topics: [awesome-deep-vision](https://github.com/kjw0612/awesome-deep-vision) ⭐ 11,177 | 🐛 47 | 📅 2023-08-15, [awesome-random-forest](https://github.com/kjw0612/awesome-random-forest) ⭐ 1,252 | 🐛 3 | 📅 2023-11-16
...
* [Caffe](https://github.com/BVLC/caffe) ⭐ 34,572 | 🐛 1,524 | 🌐 C++ | 📅 2024-07-31 - C++ with MATLAB/Python wrappers
  * [LRCN](http://jeffdonahue.com/lrcn/) by Jeff Donahue
* [Tensorflow](https://www.tensorflow.org/) - Python, C++
  * [Notebook examples](https://github.com/aymericdamien/TensorFlow-Examples) ⭐ 43,738 | 🐛 228 | 🌐 Jupyter Notebook | 📅 2024-07-26 by aymericdamien
...
* [Torch](http://torch.ch/) - Lua
  * [char-rnn](https://github.com/karpathy/char-rnn) ⭐ 12,084 | 🐛 111 | 🌐 Lua | 📅 2023-10-24 by Andrej Karpathy : multi-layer RNN/LSTM/GRU for training/sampling from character-level language models
  * [neuraltalk2](https://github.com/karpathy/neuraltalk2) ⭐ 5,590 | 🐛 142 | 🌐 Jupyter Notebook | 📅 2017-11-07 by Andrej Karpathy : Recurrent Neural Network captions image, much faster and better version of the original [neuraltalk](https://github.com/karpathy/neuraltalk) ⭐ 5,499 | 🐛 30 | 🌐 Python | 📅 2020-12-22
...
* [PyTorch](http://pytorch.org/) - Python
  * [Word-level RNN example](https://github.com/pytorch/examples/tree/master/word_language_model) ⭐ 24,004 | 🐛 251 | 🌐 Python | 📅 2025-09-01 : demonstrates PyTorch's built in RNN modules for language modeling
  ...
  * [Deep Learning For NLP In PyTorch](https://github.com/rguthrie3/DeepLearningForNLPInPytorch) ⭐ 1,957 | 🐛 9 | 🌐 Jupyter Notebook | 📅 2023-01-22 by Robert Guthrie : written for a Natural Language Processing class at Georgia Tech
...
* Etc.
  * [neuraltalk](https://github.com/karpathy/neuraltalk) ⭐ 5,499 | 🐛 30 | 🌐 Python | 📅 2020-12-22 by Andrej Karpathy : numpy-based RNN/LSTM implementation
  * [Brainstorm](https://github.com/IDSIA/brainstorm) ⭐ 1,320 | 🐛 27 | 🌐 Python | 📅 2022-09-13: deep learning library in Python, developed by IDSIA, thereby including various recurrent structures
...
* Grid LSTM \[[Paper](http://arxiv.org/pdf/1507.01526)] \[[Code](https://github.com/coreylynch/grid-lstm) ⭐ 186 | 🐛 2 | 🌐 Lua | 📅 2016-02-10]
